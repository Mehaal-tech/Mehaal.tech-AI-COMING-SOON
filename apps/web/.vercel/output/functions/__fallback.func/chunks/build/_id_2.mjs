...
import { b } from './Input-0sOzVmib2.mjs';
import { g } from './Card-D9smAXyI2.mjs';
import { createSignal } from 'solid-js';
import { y, $ } from './Topbar-UAezHi7t2.mjs';
import { w } from './Select-DpfdCahF2.mjs';
import { q as qe, W as We } from './routing-0hP7Sh6N.mjs';
...
function G() {
  const n = qe(), m = We().id === "new", [o, v] = createSignal(""), [c, f] = createSignal(""), [d, D] = createSignal(""), [u, b$1] = createSignal("draft"), [h$1, p] = createSignal(false), S = async () => {
    p(true), await new Promise((x) => setTimeout(x, 1e3)), console.log("Saving page:", { title: o(), slug: c(), content: d(), status: u() }), p(false), n("/cms/pages");
