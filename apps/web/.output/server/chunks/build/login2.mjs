...
function N() {
  const e = qe(), { setSession: t } = M(), [r, p] = createSignal(""), [m, g$1] = createSignal(""), [i, d] = createSignal(""), [w, u] = createSignal(false), f = async (v) => {
  ...
  return ssr(E, ssrHydrationKey(), escape(createComponent(g, { get children() {
    return ssr(D, ssrHydrationKey(), escape(createComponent(b, { type: "email", label: "Email", placeholder: "you@example.com", get value() {
      ...
      return m();
    }, onInput: g$1, required: true })), i() && ssr(P, ssrHydrationKey(), escape(i())), escape(createComponent(h, { variant: "primary", class: "w-full", get loading() {
      return w();
